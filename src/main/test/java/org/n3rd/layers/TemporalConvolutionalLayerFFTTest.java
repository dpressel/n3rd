...
public class TemporalConvolutionalLayerFFTTest
{
    ...
    {
        TemporalConvolutionalLayerFFT l = new TemporalConvolutionalLayerFFT(1, 1, 3, 1);
    ...
    public void testForward2to1WordVecAsInChannels() throws Exception
    {
        ...
        TemporalConvolutionalLayerFFT l = new TemporalConvolutionalLayerFFT(1, 2, 3, 1);
    ...
    public void testForward2to3WordVecAsInChannels() throws Exception
    {
        ...
        TemporalConvolutionalLayerFFT l = new TemporalConvolutionalLayerFFT(3, 2, 3, 1);
